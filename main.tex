...
\textbf{Answer to Q3.} The detachment mode is determined by which threshold is reached first during bubble growth (Figure~\ref{figTree}). The behavior depends strictly on the cavity radius $r_c$ relative to the wetting angle $\phi_w$ and the capillary length $\lambda$, as summarised in Table~\ref{tabDetachment}.
